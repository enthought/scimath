...
def convert_log_index(log_index, unit_system=None,
                      to_unit=None, family_name=None):
...
def convert_log(log, unit_system=None, to_unit=None, family_name=None):
    ...
    if typecode(log.data) == ObjectType:
        ...
        new_log = convert_log_index(
            log, family_name=family_name, to_unit=to_unit)
        new_log.index = new_index
    return new_log


def convert_log_suite(log_suite, unit_system=None,
                      to_unit=None, family_name=None):
...
def convert_action_variable(
        q, unit_system=None, to_unit=None, family_name=None):
    import copy
...
def convert_log_proxy(q, unit_system=None, to_unit=None, family_name=None):
    ...
    index_copy = LogIndex(
        ...
        units=q.index.units,
        name=q.index.name,
        family_name=q.index.family_name)
    log_copy = Log(
        q.data,
        index=index_copy,
        units=q.units,
        name=q.name,
        family_name=q.family_name)
    return convert_log(log_copy, unit_system=unit_system,
                       to_unit=to_unit, family_name=family_name)
