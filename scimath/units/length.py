...
#               (c) 1998-2003
#
# Symbols defined: nano- micro- milli- centi- kilo-...meter [and variants]
#                  inch, foot, yard, mile, fathom, nautical_mile
#                  angstrom, fermi, astronomical_unit, light_year, parsec,
#
#------------------------------------------------------------------------------
